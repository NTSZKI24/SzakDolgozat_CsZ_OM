...
namespace SzakDolgozat.SQL
{
    public class SQL : DbContext
    {
        ...
        {
            var options = new DbContextOptionsBuilder().UseSqlServer(SQL.ConnectionString);
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Admin__munkalapok_View_>().ToView("Admin_(/munkalapok_View)").HasNoKey();
